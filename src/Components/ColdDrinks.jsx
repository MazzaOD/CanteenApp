...
function ColdDrinks({ setView }) {
  ...
  useEffect(() => {
    fetch('/assets/coldDrinks.json')
      .then((response) => response.json())
      .then((data) => setColdDrinks(data))
      .catch((error) => console.error('Error loading cold drinks:', error));
  }, []);
...
const handleOrder = (item, index) => {
  ...
  return (
    <div className="container mx-auto px-4 py-10 text-center">
      <h2 className="text-4xl font-bold text-gray-800 mb-8">Cold Drinks</h2>
