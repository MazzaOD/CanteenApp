...
function HotDrinks({ setView }) {
  ...
  useEffect(() => {
    fetch('/assets/hotDrinks.json')
      .then((response) => response.json())
      .then((data) => setHotDrinks(data))
      .catch((error) => console.error('Error loading hot drinks:', error));
  }, []);
  ...
  return (
    <div className="container mx-auto px-4 py-10 text-center">
      <h2 className="text-4xl font-bold text-gray-800 mb-8">Hot Drinks</h2>
